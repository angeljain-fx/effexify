...
$("#quote-circle2").click(function() {
  ...
  $(".quoteSubHeader").fadeOut(function () {
              $(".quoteSubHeader").text(($(".quoteSubHeader").text() == "As an interior design agency, we needed a website design with high-quality content and aesthetics. The final product delivered by Effexify's team was beyond our expectations!" || "Their homepage redesign increased our inbound inquiries by four times. Really impressed how a good web design can skyrocket sales, all thanks to Effexify.") ? "One thing that did strike us was the highly responsive and caring nature of the team at Effexify. They streamlined the entire process and delivered a very clean and attractive web design, a big thanks!" : null).fadeIn();
          });
});
...
$("#quote-circle3").click(function() {
  ...
  $(".quoteSubHeader").fadeOut(function () {
              $(".quoteSubHeader").text(($(".quoteSubHeader").text() == "As an interior design agency, we needed a website design with high-quality content and aesthetics. The final product delivered by Effexify's team was beyond our expectations!" || "One thing that did strike us was the highly responsive and caring nature of the team at Effexify. They streamlined the entire process and delivered a very clean and attractive web design, a big thanks!") ? "Their homepage redesign increased our inbound inquiries by four times. Really impressed how a good web design can skyrocket sales, all thanks to Effexify." : null).fadeIn();
          });
});
